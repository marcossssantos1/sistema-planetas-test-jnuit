...
public class PlanetIT {
  ...
  public void createPlanet_ReturnsCreated() {
    ...
    assertThat(sut.getBody().getTerain()).isEqualTo(PLANET.getTerain());
  }
  ...
  public void listPlanets_ByTerrain_ReturnsPlanets() {
    ResponseEntity<Planet[]> sut = restTemplate.getForEntity("/planets?terrain=" + TATOOINE.getTerain(),
        Planet[].class);
